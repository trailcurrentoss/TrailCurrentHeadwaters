...
echo "  images/*.tar           (7 pre-built Docker images including MongoDB and Nominatim)"
...
echo "  data/tileserver/map.mbtiles (map tiles - transferred separately, see DOCS/UpdatingMapTiles.md)"
echo "  data/nominatim/map.osm.pbf  (search dataset - transferred separately, see DOCS/UpdatingNominatim.md)"
echo ""
echo "Next steps:"
echo "  1. Transfer $ZIP_NAME to the Pi"
echo "  2. On Pi: unzip $ZIP_NAME"
echo "  3. On Pi: chmod +x deploy.sh && ./deploy.sh"
echo ""
if [ -n "$VERSION" ]; then
