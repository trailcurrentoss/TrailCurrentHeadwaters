...
export const settingsPage = {
    ...
    renderSettings() {
        ...
        return `
            ...
            <!-- Third-party licenses + attribution.
                 Renders THIRD_PARTY_LICENSES.md (synced into the frontend
                 container by build-and-save-images.sh) inline in the panel.
                 Satisfies the ODbL "attribution and share-alike is visible
                 in-app" requirement and covers every runtime dependency's
                 upstream license terms without needing to leave the app. -->
            <div class="card settings-item-vertical">
                <div class="settings-item-header">
    ...
    setupListeners() {
        ...
        // /THIRD_PARTY_LICENSES.md (served by nginx from the frontend static
        // tree — synced there by build-and-save-images.sh) and shows it in
        // the <pre> block below the button. Second click hides it again.
